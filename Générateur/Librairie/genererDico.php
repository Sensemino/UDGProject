...
// remplit un tableau en piochant alÃ©atoirement dans un dictionnaire

function genererDico($nbligne, $NomDonnees, $GenererDep,$maju="oui") { # maju ="non" par défaut ?
#echo " maju vaut $maju \n";
    $dicogene = array();
    ...
    foreach($dicogene as $key1=>$h) {
        foreach($h as $key2=>$v) {
            ...
            if ($maju=="oui") { $dicogene[$key1][$key2] = strtoupper($dicogene[$key1][$key2]) ; } ;
        } # fin pour key2
    } # fin pour key 1

    return $dicogene;

} # fin fonction genererDico
?>
